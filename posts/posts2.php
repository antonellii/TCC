...
<body>
<a href="../seguir/seguir.php" style="background-color: #ff9900; padding: 10px; border-radius: 10px; position: absolute; margin-top: 10px;">SUGESTÕES</a>
    ...
    <script>
        document.getElementById("perfilDiv").addEventListener("click", function () {
            window.location.href = "../seguir/person.php?id=<?php echo $user_id ?>";
        });
